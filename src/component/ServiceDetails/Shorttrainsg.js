...
import img1 from '../../assets/img/service-details/short.jpg'
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <p className='pt20 pb20'> NextBase has state-of-the-art research facilities and a conducive environment
